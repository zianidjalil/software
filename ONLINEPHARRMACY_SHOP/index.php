...
<div class="products">
   ...
   <h1 class="heading">full consultation here in regina maria !</h1>
...
<div class="shopping-cart">
   ...
   <table>
      ...
      <tr class="table-bottom">
         ...
         <td><a href="index.php?delete_all" onclick="return confirm('Remove all products from the cart?');" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">Delete all</a></td>
      </tr>
   </tbody>
   </table>
